        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
          <div class="modal-content">
            ...
            <div class="bg-white box-shadow pd-ltr-20 border-radius-5">
              ...
              <h2 class="text-center mb-30">Edit Data Direct Labor</h2>
            </div>
            <div class="modal-body">
            <form id="form_edit_directlbr">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label >Reg DL :</label>
                      <input class="form-control" type="number" id="et_reg_dl" name="et_reg_dl">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="number" id="et_jam_ot" name="et_jam_ot">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="number" id="et_dl_ot" name="et_dl_ot">
        ...
        <div class="modal fade" id="i_absen-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class=" bg-white box-shadow pd-ltr-20 border-radius-5">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h2 class="text-center mb-30">Tambah Absen Pegawai</h2>
                <!-- form start -->
                <form id="form_absen_pegawai">
                    ...
                    <div class="input-group custom input-group-lg">
                      ...
                      <div class="input-group-append custom">
                        <span class="input-group-text"><i class="icon-copy fi-torsos"></i></span>
                      </div>
                    </div>
                    <!-- input -->
                    <div class="input-group custom input-group-lg">
                      <input type="number" class="form-control" placeholder="Total JAM" id="i_jam" name="i_jam">
                      <div class="input-group-append custom">
            ...
            <div class="modal-content">
              <div class="bg-white box-shadow pd-ltr-20 border-radius-5">
                ...
                <form id="form_updt_absen_pegawai">
                  <!-- input -->
                  <div class="input-group custom input-group-lg">
                    <input type="text" class="form-control" placeholder="ITEM" id="item_updt" name="item_updt">
    ...
    <!-- regulasi in modal -->
        ...
        <div class="modal fade" id="i_reg_in-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class=" bg-white box-shadow pd-ltr-20 border-radius-5">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h2 class="text-center mb-30">MP Bantuan IN</h2>
                <!-- form start -->
                <form id="form_regulasi_in">
                  <!-- input -->
                  <div class="input-group custom input-group-lg">
                    <select class="custom-select col-12" name="in_jam_ke" id="in_jam_ke"> 
                        <!-- INI CONtainer JAm kE -->
                    </select> 
                  </div>
                  <!-- input -->
                  <div class="input-group custom input-group-lg">
                    <input type="text" class="form-control" placeholder="Posisi" id="i_posisi" name="i_posisi">
                    <div class="input-group-append custom">
                      <span class="input-group-text"><i class="icon-copy fa fa-id-badge" aria-hidden="true"></i></span>
                    </div>
                  </div>
                  <!-- input -->
                  <div class="input-group custom input-group-lg">
                    <input type="number" class="form-control" placeholder="QTY MP" id="i_regin_qty" name="i_regin_qty">
                    <div class="input-group-append custom">
                      <span class="input-group-text"><i class="icon-copy fi-torsos"></i></span>
                    </div>
                  </div>
                  <!-- input -->
                  <div class="input-group custom input-group-lg">
                    <input type="number" class="form-control" placeholder="JAM" id="i_regin_jam" name="i_regin_jam">
                    <div class="input-group-append custom">
                      <span class="input-group-text"><i class="icon-copy fa fa-clock-o" aria-hidden="true"></i></span>
                    </div>
                  </div> 
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                        <div class="input-group">
                          <a class="btn btn-primary btn-lg btn-block" href="#" id="btn_submit_regin">Tambahkan</a>
                        </div>
                    </div>
                  </div>
                </form>
      ...
      <!-- modal update -->
          <div class="modal fade" id="updt_regin_modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
              <form id="fomUpdatemhin">
                <div class=" bg-white box-shadow pd-ltr-20 border-radius-5">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                  <h2 class="text-center mb-30">Update MP Bantuan In</h2>
                  <!-- form start -->
                    <!-- input -->
                    <div class="input-group custom input-group-lg"> 
                      <select class="custom-select col-12" name="jamke_regin_updt" id="jamke_regin_updt">
                            <!-- ID CONTAINER JAM KE -->
                      </select> 
                     </div>
                    <!-- input -->
                    <div class="input-group custom input-group-lg">
                      <input type="text" class="form-control" placeholder="POSISI" id="posisi_updt" name="posisi_updt">
                    ...
                    <!-- input -->
                    <div class="input-group custom input-group-lg">
                      <input type="text" class="form-control"  placeholder="QTY MP" id="qty_regin_updt" name="qty_regin_updt" >
                      <div class="input-group-append custom">
                        <span class="input-group-text"><i class="icon-copy fi-torsos"></i></span>
                      </div>
                    </div>
    ...
    <!-- regulasi out modal -->
      <!-- modal input -->
        <div class="modal fade" id="i_reg_out-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <form id="form__regulasi_outinsert">
                  <div class="bg-white box-shadow pd-ltr-20 border-radius-5">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h2 class="text-center mb-30">MP Bantuan OUT</h2> 
                      <!-- input -->
                      <div class="input-group custom input-group-lg">
                      ...
                      <!-- input -->
                      <div class="input-group custom input-group-lg">
                        <input type="text" class="form-control" placeholder="Posisi" id="posisi_i" name="posisi_i">
                        <div class="input-group-append custom">
                          <span class="input-group-text"><i class="icon-copy fa fa-id-badge" aria-hidden="true"></i></span>
                        </div>
                      </div>
                      <!-- input -->
                      <div class="input-group custom input-group-lg">
                        <input type="number" class="form-control" placeholder="QTY MP" id="regin_qty_i" name="regin_qty_i">
                        <div class="input-group-append custom">
                          <span class="input-group-text"><i class="icon-copy fi-torsos"></i></span>
                        </div>
                      </div>
                      <!-- input -->
                      <div class="input-group custom input-group-lg">
                        <input type="number" class="form-control" placeholder="JAM" id="regin_jam_i" name="regin_jam_i">
                        <div class="input-group-append custom">
                          <span class="input-group-text"><i class="icon-copy fa fa-clock-o" aria-hidden="true"></i></span>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                            <div class="input-group">
                              <a class="btn btn-primary btn-lg btn-block" href="#" id="btn_submit_regout">Tambahkan</a>
                            </div>
                        </div>
                      </div>  
                  </div>
              ...
              <div class="bg-white box-shadow pd-ltr-20 border-radius-5">
                ...
                <form id="form_addactiv">
                  <div class="input-group custom input-group-lg">
                    ...
                    <input id="nameAct" name="nameAct" type="text" class="form-control" style="text-align: left;" placeholder="Nama Aktivitas">
            ...
            <div class="modal-content">
              <div class="bg-white box-shadow pd-ltr-20 border-radius-5">
                ...
                <form id="form_editactiv">
                  <div class="input-group custom input-group-lg">
                    <label>Aktivitas :</label>
                    <input id="nameActedit" name="nameActedit" type="text" class="form-control" style="text-align: left;" placeholder="Nama Aktivitas"> 
                  </div>
                  <div class="form-group">
                    <label>Durasi :</label>
...
<script>
    ...
    //
                        ...
                        '<tr>'+
                          ...
                          '<th>'+
                            '<div style=" vertical-align: middle; text-align: center;" class="dropdown">'+
                                ...
                                '</a>'+                     
                                '<div class="dropdown-menu dropdown-menu-right">'+
                                  '<a  class="dropdown-item item_edit_regout" href="#" data-id_oc_regout="'+data[i].idoc+'" data-id_regout="'+data[i].id+'" data-posisi_out="'+data[i].posisi+'" data-qty_regout="'+data[i].qty+'" data-jam_regout="'+data[i].jam+'" data-total_regout="'+data[i].total+'"><i class="fa fa-pencil"></i> Edit </a>'+
      ...
      // +++++++++++++++======== END  DIRECT LABOR  END ===========================

      // ===================  B. NON OPERATING HOURS ===============================================
        // ini tambah Absen
          $( "#form_absen_pegawai" ).validate({
            rules: {
              i_item: {
                required: true
              },
        ...
        // ini Update ABSEN
          //get data for UPDATE record show prompt
            ...
            //UPDATE record to database (submit button)
              // Validation Rule
              $( "#form_updt_absen_pegawai" ).validate({
                rules: {
                  item_updt: {
                    required: true
                  },
              ...
              $('#btn_update_absen').on('click',function(){
                  // check is valid or not
                  if (!$('#form_updt_absen_pegawai').valid()) { 
                    return;
                  }  
      ...
      // =================== END NON OPERATING HOURS END  ==========================================
 
      // regulasi in ajax
      // ===================  D MP BANTUAN IN    ==================================
          // ADD REGULASI IN
            $( "#form_regulasi_in" ).validate({
              rules: {
                i_posisi: {
                  required: true
                },
            ...
            $('#btn_submit_regin').click(function(){
              ...
              $.ajax({
                ...
                success : function(response){
                  ...
                  document.getElementById("form_regulasi_in").reset();
                }
              });
              isyou(id_pdo);
            });
          // UPDATE REGULASI IN
            //trigger
                $('#regin_tbody').on('click','.item_edit_regin',function(){
                  ...
                  var id_oc = $(this).data('id_oc_regin'); 
      ...
      // ===============  END MP BANTUAN IN  END  ==================================

      // regulasi out ajax      
      // ===================  D MP BANTUAN OOOUTTT    ==================================
          // ADD INSERT
              // Validasi
              $('#form__regulasi_outinsert').validate({
                rules: { 
                  regin_qty_i:{
                    required: true
                  },
              ...
              $('#btn_submit_regout').click(function(){
                // JIKA Telah Memenuhi persyaratan validasi
                 if (!$('#form__regulasi_outinsert').valid()) { 
                    return;
                 }  
                 ...
                 var regout_jam = document.getElementById("regin_jam_i").value;
                  $.ajax({
                    ...
                    success : function(response){
                      ...
                      document.getElementById("form__regulasi_outinsert").reset();
                    }
                  });
                  isyou(id_pdo);
              });
      ...
      // ======================  E INDIRECT ACTV     =================================
        ...
        // edit act
          ...
          // validasi
            $('#form_editactiv').validate({
              rules: { 
                nameActedit:{
                  required: true
                },
                durasi_aktivitas_edit:{
                  required: true
                }
              }
            });
