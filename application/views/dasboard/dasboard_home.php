				...
				$.ajax({ 
	                ...
	                success : function(res){ 
							...
							if (res) { //--->>>> masuk PDO TERSEDIA
	                    		...
	                    		// Menghitung Auto Plan
	                    			autoplan = [];
		                    		var jam_eff =res.jam_effective;
		                    		// console.log('Asli jam : '+jam_eff);
		                    		// console.log(''); 
									...
									for (var i = 7; i >= 0; i--) {
										...
										// console.log('jam '+x+' : '+j_ef);
										// console.log('tot : '+(j_ef*3600).toFixed(0));
										// console.log('sum : '+(j_ef*3600).toFixed(0)/res.line_speed);	
										if (x!=1) {
											sisa = ((j_ef*3600).toFixed(0)/res.line_speed) - (Math.floor(((j_ef*3600).toFixed(0)/res.line_speed))); 
										}

										var sum_sis = ((j_ef*3600).toFixed(0)/res.line_speed)+sisa;
										// console.log('sum sisa : '+sum_sis);
										// console.log('fix : '+Math.floor(sum_sis));   
										// console.log(sisa); 
										// console.log('');
