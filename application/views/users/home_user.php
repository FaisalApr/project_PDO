							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input id="in_nama" name="in_nama" type="text" class="form-control" minlength="2">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group" id="fom_iusername">
										...
										<input id="in_username" name="in_username" type="text" class=" form-control" minlength="2">
