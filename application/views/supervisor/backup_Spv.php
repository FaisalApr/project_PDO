					...
					<div class="pull-right">
						<div class="row" style="margin-top: 10px">
							...
							<div style="padding: 2px">	
								<a id="btn_tambah" href="#" class="btn btn-success" data-backdrop="static" data-toggle="modal" data-target="#i_line2-modal" style="margin-right: 3px; width: 100px"><span class="fa fa-plus"></span> Tambah </a>
							</div>
							
							<div style="padding: 2px" >	
								<a href="#" class="btn btn-primary" data-backdrop="static" data-toggle="modal" data-target="#i_spv-modal" style="margin-right: 10px; width: 80px"><span style="margin-left: 1px" class="fa fa-pencil"></span> Edit </a>
							</div>
						</div>
			                ...
			                '<th>'+
			                  '<div class="dropdown" style="vertical-align: middle; text-align: center;">'+
			                      ...
			                      '<div class="dropdown-menu dropdown-menu-right">'+
			                        ...
			                        '<a class="dropdown-item item_view" href="#" data-nama="'+data[i].nama+'" data-id="'+data[i].id+'" data-id_man="'+id_mana+'"><i class="fa fa-eye"></i> Detail </a>'+
