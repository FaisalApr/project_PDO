			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="login-box bg-white box-shadow pd-ltr-20 border-radius-5">
						...
						<h2 class="text-center mb-30">Defect Baru</h2>
						<form id="formDefect"> 
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group">
										...
										-->
										<a id="btn_submit" class="btn btn-primary btn-lg btn-block" href="#">Tambah Defect</a>
									</div>
								</div>
							</div> 
						</form>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="bg-white box-shadow pd-ltr-20 border-radius-5">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
					<h2 class="text-center mb-30">Edit Defect</h2>
		...
		$('document').ready(function(){
			...
			// ===== isi LIST Defect 
				function isi_listDefect(data) {
					...
					var html = '<option disabled selected> Jenis Defect</option>';
